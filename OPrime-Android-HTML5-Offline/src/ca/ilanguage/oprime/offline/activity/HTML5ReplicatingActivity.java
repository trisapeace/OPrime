...
public abstract class HTML5ReplicatingActivity extends HTML5Activity {
  ...
  protected String mRemoteCouchServerDomain = "";
  ...
  public String getRemoteCouchServerDomain() {
    return mRemoteCouchServerDomain;
  }
  ...
  public abstract void setCouchInfoBasedOnUserDb(String userdb, String username,
